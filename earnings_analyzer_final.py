...
if st.button("Analyze"):
    ...
    for r in results:
        ...
        with col1:
            ...
            ts_func = build_term_structure(r['term_structure'][0], r['term_structure'][1])
            y_vals = [ts_func(x) for x in x_vals]
            ax.plot(x_vals, y_vals, label='Interpolated IV', color='blue')
            ax.set_xlim(0, 45)
            ax.set_title("Implied Volatility Term Structure (0-45 Days)")
